<?php
/**
 * koeksisters functions and definitions.
 *
...
if ( ! function_exists( 'koeksisters_setup' ) ) :
/**
 ...
 */
function koeksisters_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on koeksisters, use a find and replace
	 * to change 'koeksisters' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'koeksisters', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'koeksisters' ),
	) );
 ...
 */
function koeksisters_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'koeksisters_content_width', 640 );
}
add_action( 'after_setup_theme', 'koeksisters_content_width', 0 );
 ...
 */
function koeksisters_widgets_init() {
...
add_action( 'widgets_init', 'koeksisters_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function koeksisters_scripts() {
